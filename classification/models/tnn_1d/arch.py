...
@register_model
def tno_vit_e3g1_small_rpe_l1_90_prenorm_large_rpe(pretrained=False, **kwargs):
    dim = 384
    glu_dim = dim
    rpe_dim = 64
    num_heads = 1
...
########## Deit large
@register_model
def tno_vit_e3g1_large_rpe_l1_90_prenorm(pretrained=False, **kwargs):
    dim = 512
    glu_dim = dim
    rpe_dim = 48
    num_heads = 1
...
@register_model
def tno_vit_e3g1_large_rpe_l1_90_prenorm_p14(pretrained=False, **kwargs):
    dim = 512
    glu_dim = dim
    rpe_dim = 48
    num_heads = 1
...
########## Deit big
@register_model
def tno_vit_e3g1_big_rpe_l1_90_prenorm(pretrained=False, **kwargs):
    dim = 768
    glu_dim = dim
    rpe_dim = 48
    num_heads = 1
