...
@register_model
def norm_vit_small_patch16_224_mix_softmax_1_elu_rmsnorm_glu_h1(pretrained=False, **kwargs):
    patch_size = 16
    dim = 384
    depth = 12
    heads = 1
...
@register_model
def norm_vit_small_patch16_224_mix_relu_elu_rmsnorm_glu_h1(pretrained=False, **kwargs):
    patch_size = 16
    dim = 384
    depth = 12
    heads = 1
