...
@register_model
def tnn_2d_vit_small_rpe_v8_64_l1_prenorm_90(pretrained=False, **kwargs):
    dim = 384
    glu_dim = dim
    rpe_dim = 64
    num_heads = 1
...
@register_model
def tnn_2d_vit_small_rpe_v8_128_l1_prenorm_90(pretrained=False, **kwargs):
    dim = 384
    glu_dim = dim
    rpe_dim = 128
    num_heads = 1
...
@register_model
def tnn_2d_vit_small_rpe_v8_256_l1_prenorm_90(pretrained=False, **kwargs):
    dim = 384
    glu_dim = dim
    rpe_dim = 256
    num_heads = 1
...
########## Deit big
@register_model
def tnn_2d_vit_big_rpe_v8_l1_prenorm_90(pretrained=False, **kwargs):
    dim = 768
    glu_dim = dim
    rpe_dim = 32
    num_heads = 1
...
@register_model
def tnn_2d_vit_big_rpe_64_l1_prenorm_90(pretrained=False, **kwargs):
    dim = 768
    glu_dim = dim
    rpe_dim = 64
    num_heads = 1
...
########## InterImage
@register_model
def tnn_2d_ii_small_rpe_prenorm(pretrained=False, **kwargs):
    patch_size = 4
    dim = 64
    glu_dim = dim * 2
    rpe_dim = 16
