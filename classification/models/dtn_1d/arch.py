...
########## Deit small
@register_model
def dnn_vit_small_rpe_l1_90_glu_2_4_3_no_decay(pretrained=False, **kwargs):
    dim = 384
    expand_ratio = 2
    use_glu = True
    glu_dim = 4 * dim // 3
...
@register_model
def dnn_vit_small_rpe_l1_90_e3_no_decay(pretrained=False, **kwargs):
    dim = 384
    expand_ratio = 3
    depth = 12
    model = DTNVit(
...
@register_model
def dnn_vit_small_rpe_l1_90_e2_no_decay(pretrained=False, **kwargs):
    dim = 384
    expand_ratio = 2
    depth = 12 * 3 // 2
    model = DTNVit(
...
@register_model
def dnn_vit_small_rpe_l1_90_e1_no_decay(pretrained=False, **kwargs):
    dim = 384
    expand_ratio = 1
    depth = 12 * 3
    model = DTNVit(
...
########## Deit base
@register_model
def dnn_vit_base_rpe_l1_90_glu_2_4_3_no_decay(pretrained=False, **kwargs):
    dim = 768
    expand_ratio = 2
    use_glu = True
    glu_dim = 4 * dim // 3
...
@register_model
def dnn_vit_base_rpe_l1_90_e2_no_decay(pretrained=False, **kwargs):
    dim = 768
    expand_ratio = 2
    depth = 12 * 3 // 2
    model = DTNVit(
